...
class CoreCompetenciesView extends Component {
    ...
    render() {
        return (
            <ContentWrapper>
                <div className="content-heading">Core Competencies</div>
                {/* START timeline */}
                {/* ul.timeline-alt */}
                <ul className="timeline">
                    ...
                    <li className="timeline-separator" data-datetime="Second Term"></li>
                    ...
                    {/* END timeline item */}
                    {/* START timeline separator */}
                    <li className="timeline-separator" data-datetime="Third Term"></li>
                    {/* END timeline separator */}
                    {/* START timeline item */}
                    <li className="timeline-inverted">
...
export default CoreCompetenciesView;
