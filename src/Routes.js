...
import LessonsView from "./components/WattbaViews/LessonsView";
import AllLessonsView from "./components/WattbaViews/AllLessonsView";
import LessonDetailView from "./components/WattbaViews/LessonDetailView";
import AuthorLessonView from "./components/WattbaViews/AuthorLessonView";
import CoreCompetenciesView from "./components/WattbaViews/CoreCompetenciesView";
                    ...
                    <div>
                        <Suspense fallback={<PageLoader/>}>
                            <Switch location={location}>
                                ...
                                {/* WATTBA */}
                                {/*Dashboard*/}
                                <Route path="/lessons" component={waitFor(LessonsView)}/>
                                <Route path="/lessons-all" component={waitFor(AllLessonsView)}/>
                                <Route path="/lesson-detail" component={waitFor(LessonDetailView)}/>
                                <Route path="/lesson-author" component={waitFor(AuthorLessonView)}/>
                                <Route path="/core-competencies" component={waitFor(CoreCompetenciesView)}/>
